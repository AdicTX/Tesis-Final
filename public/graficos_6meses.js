demo = {
  initChartsPages: function () {
    ...
    const anho1 = async () => {
      ...
      var speedCanvas = document.getElementById("semestre1");
      ...
      var speedCanvas = document.getElementById("semestre2");

      var semestre2 = {
        data: [mes7, mes8, mes9, mes10, mes11, mes12],
        fill: false,
        borderColor: "#F03F3F",
        backgroundColor: "transparent",
        pointBorderColor: "#F03F3F",
      ...
      var semestre1 = mes1 + mes2 + mes3 + mes4 + mes5 + mes6;
      var semestre2 = mes7 + mes8 + mes9 + mes10 + mes11 + mes12;
      console.log(semestre1);
      var objetivoEE = document.getElementById("sema121");
      objetivoEE.innerHTML = semestre1;
      var objetivoEEE = document.getElementById("sema222");
      objetivoEEE.innerHTML = semestre2;
    };
